...
public class WaterUtil {
    ...
    /**
     * The maximum capacity of water that can be held in a quarter empty tile without it
     * overflowing.
     */
    ...
    /**
     * A cell can hold 1/COMPRESSION_FACTOR extra if the cell above is full (assuming both have same
     * capacity).
     */
    ...
    /**
     * A fake water region, for referencing in situations where there is no water region in a given
     * direction.
     */
    ...
    /**
     * Update the flow given some contents to split between some directions in ratio with the
     * capacities.
     */

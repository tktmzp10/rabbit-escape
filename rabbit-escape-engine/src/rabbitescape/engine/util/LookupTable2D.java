...
public class LookupTable2D<T extends LookupItem2D> implements Iterable<T> {
    ...
    /**
     * The size this table was created with. Note that changing the dimensions will not change the
    ...
    /**
     * Convert coordinate to index. This allows the table to store items 1 place outside the nominal
     * size.
     */
    private int i(int c) {
        return c + 1;

...
/**
 * Supply a long form option (eg "--start"). The short form is generated automatically (eg "-s").
 * Parameters may be supplied as the next arg, or concatenated ( "-s 0", "-s0"). Also with equals is
 * fine (eg --start=0). Limitations; * Options must begin "--". * Different options cannot begin
 * with the same letter * Options may not be repeated on the command line. * parameters cannot start
 * with "=".
 */
public class CommandLineOption {
    ...
    /**
     * Checks if the command line argument is a match for this one. Also tests for concatenated
     * param.
     */

...
public class SolutionRunner {
    ...
    /**
     * @param output A stream (eg System.out) to print to. May be null if no output is required.
    ...
    /**
     * If we have no next step, or the world is finished and the step is just an assertion step,

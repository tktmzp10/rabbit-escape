...
import static rabbitescape.engine.ChangeDescription.State.FIRE_B_FALL_TO_RISE_RIGHT;
...
public class FireBFallToRiseRight extends FireStates {

    @Override
    public State getState() {
        return FIRE_B_FALL_TO_RISE_RIGHT;
    }

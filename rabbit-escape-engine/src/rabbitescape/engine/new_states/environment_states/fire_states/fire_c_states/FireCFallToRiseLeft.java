...
import static rabbitescape.engine.ChangeDescription.State.FIRE_C_FALL_TO_RISE_LEFT;

import rabbitescape.engine.BehaviourTools;
import rabbitescape.engine.ChangeDescription.State;
import rabbitescape.engine.new_states.environment_states.FireStates;

public class FireCFallToRiseLeft extends FireStates {

    @Override
    public State getState() {
        return FIRE_C_FALL_TO_RISE_LEFT;
    }

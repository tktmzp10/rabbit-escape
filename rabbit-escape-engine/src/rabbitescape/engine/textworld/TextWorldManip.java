...
public class TextWorldManip {
    ...
    /**
     * Adds a line of metadata to the supplied List. If there are any comments for this key comment
     * lines will be added first.
     *
    ...
    private static void addMeta(
        ...
        if (null == value) { // We were only here to consider adding comments.
            return;
        } else {
            lines.add(":" + key + "=" + value);
        }

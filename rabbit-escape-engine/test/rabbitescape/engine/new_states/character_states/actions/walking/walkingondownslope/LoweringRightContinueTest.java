...
public class LoweringRightContinueTest {

    private World world = TextWorldManip.createEmptyWorld(3, 4);
    private Character character = new Rabbit(1, 1, RIGHT);
    private LoweringRightContinue loweringLeftEnd = new LoweringRightContinue();

    @Test
    public void getState() {
        assertEquals(RABBIT_LOWERING_RIGHT_CONTINUE, loweringLeftEnd.getState());
    }

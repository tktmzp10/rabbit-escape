...
public class BridgingInCornerUpLeft2Test {

    private World world = TextWorldManip.createEmptyWorld(3, 4);
    private Character character = new Rabbit(1, 1, RIGHT);
    private static Bridging bridging = new Bridging();
    private BridgingInCornerUpLeft2 bridgingInCornerUpLeft2 = new BridgingInCornerUpLeft2();

    @Test
    public void getState() {
        assertEquals(RABBIT_BRIDGING_IN_CORNER_UP_LEFT_2, bridgingInCornerUpLeft2.getState());
    }

    @Test
    public void behave() {
        assertTrue(bridgingInCornerUpLeft2.behave(world, character, bridging));
    }
}
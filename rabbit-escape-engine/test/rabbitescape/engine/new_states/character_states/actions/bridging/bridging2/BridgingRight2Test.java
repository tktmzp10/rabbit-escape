...
public class BridgingRight2Test {

    private World world = TextWorldManip.createEmptyWorld(3, 4);
    private Character character = new Rabbit(1, 1, RIGHT);
    private static Bridging bridging = new Bridging();
    private BridgingRight2 bridgingRight2 = new BridgingRight2();

    @Test
    public void getState() {
        assertEquals(RABBIT_BRIDGING_RIGHT_2, bridgingRight2.getState());
    }

    @Test
    public void behave() {
        assertTrue(bridgingRight2.behave(world, character, bridging));
    }
}
...
public class BridgingInCornerRight2Test {

    private World world = TextWorldManip.createEmptyWorld(3, 4);
    private Character character = new Rabbit(1, 1, RIGHT);
    private static Bridging bridging = new Bridging();
    private BridgingInCornerRight2 bridgingInCornerRight2 = new BridgingInCornerRight2();

    @Test
    public void getState() {
        assertEquals(RABBIT_BRIDGING_IN_CORNER_RIGHT_2, bridgingInCornerRight2.getState());
    }

    @Test
    public void behave() {
        assertTrue(bridgingInCornerRight2.behave(world, character, bridging));
    }
}
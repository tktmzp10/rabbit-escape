...
public class BridgingLeft1Test {

    private World world = TextWorldManip.createEmptyWorld(3, 4);
    private Character character = new Rabbit(1, 1, RIGHT);
    private static Bridging bridging = new Bridging();
    private BridgingLeft1 bridgingLeft1 = new BridgingLeft1();

    @Test
    public void getState() {
        assertEquals(RABBIT_BRIDGING_LEFT_1, bridgingLeft1.getState());
    }

    @Test
    public void behave() {
        assertTrue(bridgingLeft1.behave(world, character, bridging));
    }
}
...
public class BridgingDownUpRight3Test {

    private World world = TextWorldManip.createEmptyWorld(3, 4);
    private Character character = new Rabbit(1, 1, RIGHT);
    private Bridging bridging = new Bridging();
    private BridgingDownUpRight3 bridgingDownUpRight3 = new BridgingDownUpRight3();

    @Test
    public void getState() {
        assertEquals(RABBIT_BRIDGING_DOWN_UP_RIGHT_3, bridgingDownUpRight3.getState());
    }

    @Test
    public void behave() {
        assertTrue(bridgingDownUpRight3.behave(world, character, bridging));
    }
}
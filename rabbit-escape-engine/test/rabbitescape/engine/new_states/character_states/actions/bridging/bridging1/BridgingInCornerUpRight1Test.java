...
public class BridgingInCornerUpRight1Test {

    private World world = TextWorldManip.createEmptyWorld(3, 4);
    private Character character = new Rabbit(1, 1, RIGHT);
    private static Bridging bridging = new Bridging();
    private BridgingInCornerUpRight1 bridgingInCornerUpRight1 = new BridgingInCornerUpRight1();

    @Test
    public void getState() {
        assertEquals(RABBIT_BRIDGING_IN_CORNER_UP_RIGHT_1, bridgingInCornerUpRight1.getState());
    }

    @Test
    public void behave() {
        assertTrue(bridgingInCornerUpRight1.behave(world, character, bridging));
    }
}
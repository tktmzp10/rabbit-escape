...
public class BridgingUpRight2Test {

    private World world = TextWorldManip.createEmptyWorld(3, 4);
    private Character character = new Rabbit(1, 1, RIGHT);
    private static Bridging bridging = new Bridging();
    private BridgingUpRight2 bridgingUpRight2 = new BridgingUpRight2();

    @Test
    public void getState() {
        assertEquals(RABBIT_BRIDGING_UP_RIGHT_2, bridgingUpRight2.getState());
    }

    @Test
    public void behave() {
        assertTrue(bridgingUpRight2.behave(world, character, bridging));
    }
}
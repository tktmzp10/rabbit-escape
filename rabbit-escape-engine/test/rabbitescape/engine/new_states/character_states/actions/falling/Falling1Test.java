...
public class Falling1Test {
    ...
    private static Falling1 falling1 = new Falling1();

    @Test
    public void getState() {
        assertEquals(RABBIT_FALLING_1, falling1.getState());
    }

    @Test
    public void behave() {
        assertTrue(falling1.behave(world, character, falling));
    }
}
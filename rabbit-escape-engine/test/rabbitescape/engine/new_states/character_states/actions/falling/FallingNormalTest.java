...
public class FallingNormalTest {
    ...
    private static FallingNormal fallingNormal = new FallingNormal();

    @Test
    public void getState() {
        assertEquals(RABBIT_FALLING, fallingNormal.getState());
    }

    @Test
    public void behave() {
        assertTrue(fallingNormal.behave(world, character, falling));
    }
}
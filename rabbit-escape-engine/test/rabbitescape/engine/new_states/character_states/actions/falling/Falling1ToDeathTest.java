...
public class Falling1ToDeathTest {
    ...
    private static Falling1ToDeath falling1ToDeath = new Falling1ToDeath();

    @Test
    public void getState() {
        assertEquals(RABBIT_FALLING_1_TO_DEATH, falling1ToDeath.getState());
    }

    @Test
    public void behave() {
        assertTrue(falling1ToDeath.behave(world, character, falling));
    }
}
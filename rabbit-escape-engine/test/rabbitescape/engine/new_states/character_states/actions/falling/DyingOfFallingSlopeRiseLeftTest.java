...
public class DyingOfFallingSlopeRiseLeftTest {
    ...
    private static DyingOfFallingSlopeRiseLeft dyingOfFallingSlopeRiseLeft = new DyingOfFallingSlopeRiseLeft();

    @Test
    public void getState() {
        assertEquals(RABBIT_DYING_OF_FALLING_SLOPE_RISE_LEFT, dyingOfFallingSlopeRiseLeft.getState());
    }

    @Test
    public void behave() {
        assertTrue(dyingOfFallingSlopeRiseLeft.behave(world, character, falling));
    }
}
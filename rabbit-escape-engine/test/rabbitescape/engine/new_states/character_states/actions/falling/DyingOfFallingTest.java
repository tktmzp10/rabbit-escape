...
public class DyingOfFallingTest {
    ...
    private static DyingOfFalling dyingOfFalling = new DyingOfFalling();

    @Test
    public void getState() {
        assertEquals(RABBIT_DYING_OF_FALLING, dyingOfFalling.getState());
    }

    @Test
    public void behave() {
        assertTrue(dyingOfFalling.behave(world, character, falling));
    }
}
...
public class FallingOntoLowerRightTest {
    ...
    private static FallingOntoLowerRight fallingOntoLowerRight = new FallingOntoLowerRight();

    @Test
    public void getState() {
        assertEquals(RABBIT_FALLING_ONTO_LOWER_RIGHT, fallingOntoLowerRight.getState());
    }

    @Test
    public void behave() {
        assertTrue(fallingOntoLowerRight.behave(world, character, falling));
    }
}
...
public class DyingOfFalling2Test {
    ...
    private static DyingOfFalling2 dyingOfFalling2 = new DyingOfFalling2();

    @Test
    public void getState() {
        assertEquals(RABBIT_DYING_OF_FALLING_2, dyingOfFalling2.getState());
    }

    @Test
    public void behave() {
        assertTrue(dyingOfFalling2.behave(world, character, falling));
    }
}
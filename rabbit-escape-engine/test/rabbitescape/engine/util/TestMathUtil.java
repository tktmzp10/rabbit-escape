...
public class TestMathUtil {
    ...
    /**
     * If {@link MathUtil#constrain} is called with min larger than max the output is undefined.
     * Since this is such a low level utility it seems wrong to validate that the min is not more
     * than the max, so here we confirm the current behaviour. If new behaviour is desired in the
     * future this test can be updated.
     */
    @Test

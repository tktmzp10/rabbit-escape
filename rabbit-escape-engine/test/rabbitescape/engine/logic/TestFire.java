...
public class TestFire {
    ...
    /**
     * A slightly complicated scenario where a fire is extinguished by water. In order to check the
     * fire has gone, a character is used (sacrificed) to redirect the water away from the spot
     * where the fire was, in order to prove that it is now empty.
     */
    @Test
